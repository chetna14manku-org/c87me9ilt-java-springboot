...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/rhtap-qe-java-springboot:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/c87me9ilt-java-springboot-gitops
